    ...
    >
      <div className="relative pointer-events-none">
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
          {[...Array(SUN_ANIMATION.dotCounts.outer)].map((_, i) => {
            const angle = (i * 360) / SUN_ANIMATION.dotCounts.outer;
          ...
          {[...Array(SUN_ANIMATION.dotCounts.middle)].map((_, i) => {
            const angle = (i * 360) / SUN_ANIMATION.dotCounts.middle + 7.5;
            const radian = (angle * Math.PI) / 180;
          ...
          {[...Array(SUN_ANIMATION.dotCounts.extended)].map((_, i) => {
            const angle = (i * 360) / SUN_ANIMATION.dotCounts.extended + 11.25;
            const radian = (angle * Math.PI) / 180;
        ...
        <div className="absolute inset-0">
          {[...Array(SUN_ANIMATION.particleCount)].map((_, i) => {
